...
public class ProductController {
    ...
    public void selectAllProductList() {
        ...
        if(productList != null && !productList.isEmpty()) {
            ...
            productPrint.printSuccessMessage("select");
        } else {
    ...
    public void selectProductByCondition(SearchCondition searchCondition) {
        ...
        if(productList != null && !productList.isEmpty()) {
            ...
            productPrint.printSuccessMessage("byCondition");
        } else {
            productPrint.printErrorMessage("byCondition");
        }
    ...
    public void registNewProduct(ProductDTO newProduct) {
        ...
        productDTO.setOriginCost(newProduct.getOriginCost());
        productDTO.setDiscountRate(newProduct.getDiscountRate());
        productDTO.setSalesQuantity("0");
        productDTO.setStockQuantity(newProduct.getStockQuantity());
        productDTO.setCategoryCode(newProduct.getCategoryCode());
    ...
    public void modifyProductInfo(ProductDTO product) {
        ...
        productDTO.setProductionStatus(product.getProductionStatus());
        //　  (조건 2) Service 객체를 호출하여 수정을 수행하고, 결과를 boolean 값으로 return 받으세요.
        boolean result = productService.modifyProductInfo(productDTO);
