...
public class ProductController {
    ...
    public void selectAllProductList() {
        ...
        if(productList != null && !productList.isEmpty()) {
            ...
            productPrint.printSuccessMessage("selectAllProductList");
        } else {
    ...
    public void selectProductByCondition(SearchCondition searchCondition) {
        ...
        if(productList != null && !productList.isEmpty()) {
            ...
            productPrint.printSuccessMessage("selectProductByCondition");
        } else {
    ...
    public void registNewProduct(ProductDTO product) {
        ...
        productDTO.setOriginCost(product.getOriginCost());
